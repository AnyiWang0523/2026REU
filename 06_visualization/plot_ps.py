# ============================================================
# Monthly Supply + PDSI Line Plot - Public Supply
...
GW_CSV     = os.path.join(BASE_DIR, "output", "PS_GW", "monthly", "PS_GW_monthly_2000_2020.csv")
SW_CSV     = os.path.join(BASE_DIR, "output", "PS_SW", "monthly", "PS_SW_monthly_2000_2020.csv")
OUTPUT_DIR = os.path.join(BASE_DIR, "output", "PS_plots")
...
# ============================================================
print("=" * 50)
print("STEP 1: Loading PS GW and SW monthly data...")
print("=" * 50)
...
# ============================================================
print("\n" + "=" * 50)
print("STEP 2: Loading HUC4-State mapping from PS_GW CSV...")
print("=" * 50)

wsdi_csv = os.path.join(BASE_DIR, "output", "PS_GW", "WSDI_PS_GW_HUC4_2000_2020.csv")
...
# Fetch PDSI for all unique states
...
# Full date range 2000/01 - 2020/12
...
for huc4 in all_huc4:
    ...
    # Get state for this HUC4
    state = huc4_state.get(huc4, None)

    # ---- PDSI: expand annual value to monthly (flat line per year) ----
    pdsi_monthly = []
    ...
    fig.suptitle(
        f"Public Supply Monthly Water Use — HUC4: {huc4} | State: {state} | 2000-2020",
    ...
    # Save
    out_png = os.path.join(huc4_dir, f"PS_{huc4}_2000_2020.png")
...
print("\n" + "=" * 50)
print("All done! Results are in output/PS_plots/ folder")
print("=" * 50)