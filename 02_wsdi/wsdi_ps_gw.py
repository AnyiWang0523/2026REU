...
# Supply: PS_HUC12_GW_2000_2020.csv (local CSV)
...
OUTPUT_DIR = os.path.join(BASE_DIR, "output", "PS_GW")
...
print(f"First 3 columns: {gw_raw.columns.tolist()[:3]}")
...
out_csv = os.path.join(OUTPUT_DIR, "WSDI_PS_GW_HUC4_2000_2020.csv")
...
for yr in range(2000, 2021):
    ...
    out_shp = os.path.join(OUTPUT_DIR, f"HUC4_WSDI_PS_GW_{yr}.shp")
    merged.to_file(out_shp)
    print(f"  ✓ HUC4_WSDI_PS_GW_{yr}.shp saved")

print("\n" + "=" * 50)
print("All done! Results are in output/PS_GW/ folder")
print("=" * 50)