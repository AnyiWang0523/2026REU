...
# Supply: PS_HUC12_SW_2000_2020.csv (local CSV)
...
OUTPUT_DIR = os.path.join(BASE_DIR, "output", "PS_SW")
...
print(f"First 3 columns: {sw_raw.columns.tolist()[:3]}")

# ============================================================
# STEP 2: Parse CSV Structure (Year | Month | HUC12 columns...)
# ============================================================
print("\n" + "=" * 50)
...
out_csv = os.path.join(OUTPUT_DIR, "WSDI_PS_SW_HUC4_2000_2020.csv")
...
for yr in range(2000, 2021):
    ...
    out_shp = os.path.join(OUTPUT_DIR, f"HUC4_WSDI_PS_SW_{yr}.shp")
    merged.to_file(out_shp)
    print(f"  ✓ HUC4_WSDI_PS_SW_{yr}.shp saved")

print("\n" + "=" * 50)
print("All done! Results are in output/PS_SW/ folder")
print("=" * 50)